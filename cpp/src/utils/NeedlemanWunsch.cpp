...
namespace utils
{
            ...
            while ( ( current.refIndex > 0 or current.altIndex > 0 ) and not deadEnd )
            {
                ...
                else if ( current.trace & m_insertMultiBit )
                {
                    ...
                    else
                    {
                        ...
                        for ( auto len = 2; len <= startingAltIndex; ++len )
                        {
                ...
                else if ( current.trace & m_deleteMultiBit )
                {
                    ...
                    for ( auto len = 2; len <= startingRefIndex; ++len )
                    {
    ...
    int32_t NeedlemanWunsch::getScoreMatrix()
    {
        ...
        for ( int32_t rowIndex = 1; rowIndex < refDim; ++rowIndex )
        {
            ...
            for ( int32_t colIndex = 1; colIndex < altDim; ++colIndex )
            {
