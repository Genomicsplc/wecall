...
BOOST_FIXTURE_TEST_CASE( shouldReadBedWithSingleThreeColumnLine, TestBedFileFixture )
{
...
BOOST_FIXTURE_TEST_CASE( shouldReadBedWithMultipleThreeColumnLines, TestBedFileFixture )
{
...
BOOST_FIXTURE_TEST_CASE( shouldReadRealExampleWithoutHeader, TestBedFileFixture )
{
...
BOOST_FIXTURE_TEST_CASE( shouldReadRealExampleWithHeader, TestBedFileFixture )
{
    // example take from https://genome.ucsc.edu/FAQ/FAQformat.html#format1
