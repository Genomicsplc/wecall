...
BOOST_AUTO_TEST_CASE( testMedianThrowsWithEmptyList )
{
    ...
    BOOST_CHECK_THROW( wecall::utils::functional::median( input ), wecall::utils::wecall_exception );
}
...
BOOST_AUTO_TEST_CASE( testMedianWithOneElement )
{
    ...
    BOOST_CHECK_EQUAL( expectedResult, wecall::utils::functional::median( input ) );
}
