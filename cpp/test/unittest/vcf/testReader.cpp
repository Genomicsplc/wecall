...
BOOST_AUTO_TEST_CASE( shouldParseValidVCFFilterHeaderUpperCaseID )
{
    ...
    wecall::vcf::FilterDesc filterDesc = wecall::io::TabixVCFFile::parseFilterHeaderLine( line );
...
BOOST_AUTO_TEST_CASE( shouldRaiseOnINFOHeaderType )
{
    ...
    BOOST_CHECK_THROW( wecall::vcf::FilterDesc filterDesc = wecall::io::TabixVCFFile::parseFilterHeaderLine( line ),
...
BOOST_AUTO_TEST_CASE( shouldDetectFilterIdInFilterDescs )
{
    ...
    BOOST_CHECK( wecall::io::TabixVCFFile::containsFilterId( filterDescs, id1 ) );
    BOOST_CHECK( not wecall::io::TabixVCFFile::containsFilterId( filterDescs, id2 ) );
}
